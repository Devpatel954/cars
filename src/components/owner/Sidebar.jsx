...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <label htmlFor="image"> 
            <img className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto'src={image? URL.createObjectURL(image): user?.image || "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.everypixel.com%2Fimage-3298099085884037069&psig=AOvVaw1h0ox9OW6a8NA5wZfvpFoS&ust=1759531736930000&source=images&cd=vfe&opi=89978449&ved=0CBYQjRxqFwoTCICE19PMhpADFQAAAAAdAAAAABAE"} alt="" />
