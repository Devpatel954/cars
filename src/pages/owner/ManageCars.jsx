...
const ManageCars = () => {
    ...
    const [cars,Setcaars] = useState([])
    const fetchOwnercars = async () => {
        Setcaars(dummyCarData)
    }
  ...
  return (
    ...
    <div className='px-4 pt-10 md:px-10 w-full'>
        <Title  title='ManageCars' SubTitle='Review, toggle availability, and remove cars from your fleet'/>
                ...
                <tbody>
                    {cars.map((car,index)=>(
                        <tr key={index} className='border-t border-borderColor'>
                            ...
                            <td className='p-3 max-md:hidden'>{car.category}

                            </td>
                              <td className='p-3'>{currency}{car.pricePerDay}/day
