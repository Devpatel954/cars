...
const Hero = () => {
    ...
    return (
        <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-light dark:bg-dark-900'>
            ...
            <div className='relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 sm:py-20 lg:py-32'>
                    ...
                    <div className='animate-slide-up'>
                        <div className='inline-block px-4 py-2 bg-primary-100 dark:bg-dark-700 text-primary-700 dark:text-primary-300 rounded-full text-sm font-semibold mb-6'>
                        ...
                        <div className='flex flex-col sm:flex-row gap-4 mb-12'>
                            ...
                            <button
                                ...
                                className='px-8 py-4 border-2 border-primary-600 dark:border-primary-400 text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-dark-800 font-bold rounded-xl transition-all'
                            >
                                Browse Cars
                            </button>
                        </div>
                        ...
                        <div className='grid grid-cols-3 gap-6'>
                            ...
                            <div>
                                ...
                                <div className='text-sm text-gray-600 dark:text-gray-400'>Happy Drivers</div>
                            </div>
                            <div>
                ...
                {/* Search Form */}
                <form onSubmit={handleSearch} className='mt-12 bg-white dark:bg-dark-800 rounded-2xl shadow-2xl p-6 sm:p-8 animate-slide-up'>
                    <h3 className='text-2xl font-bold text-dark-900 dark:text-white mb-6'>Find Your Perfect Car</h3>
                    
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                        {/* Location */}
                        <div>
                            <label className='text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 block'>📍 Location</label>
                            <select 
                        ...
                        {/* Pickup Date */}
                        <div>
                            <label className='text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 block'>📅 Pickup</label>
                            <input 
                                type="date" 
                                value={pickupDate}
                        ...
                        {/* Return Date */}
                        <div>
                            <label className='text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 block'>📅 Return</label>
                            <input 
                                type="date" 
                                value={returnDate}
